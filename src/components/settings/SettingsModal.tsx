                            ...
                            {isAuthenticated && user ? (
                                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
                                    <div className="flex items-center gap-4">
                                        {user.user_metadata?.avatar_url ? (
                                            <img src={user.user_metadata.avatar_url} alt="Avatar" className="w-12 h-12 rounded-full border-2 border-white dark:border-gray-600" />
                                        ) : (
                                        ...
                                        <div className="flex-1">
                                            <p className="font-bold text-gray-900 dark:text-white">{user.user_metadata?.full_name || user.email}</p>
                                    ...
                                    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <Button onClick={signOut} variant="secondary" className="w-full gap-2 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20">
                                ...
                                <div className="text-center py-6 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 max-w-xs mx-auto">Conecte sua conta para habilitar o cofre seguro e backup automático.</p>
                                    </div>
