                ...
                <div className="space-y-4">
                    ...
                    <div className="max-h-[50vh] overflow-y-auto custom-scrollbar space-y-2">
                        {drafts.map(draft => (
                            <div
                                key={draft.id}
                                className={`p-3 rounded-xl border transition-all ${draft.selected
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    <div
                                        ...
                                        className={`mt-1 w-5 h-5 rounded-full border flex-shrink-0 flex items-center justify-center cursor-pointer transition-colors ${draft.selected ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-gray-400'
                                            }`}
                                    >
